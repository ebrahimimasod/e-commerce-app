...
class UpdateSellerRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'email'                        =>  ['required','email','max:50',Rule::unique('sellers')->ignore($this->id)],
            'mobile'                       =>  ['required', 'numeric', 'regex:/^((09)[0-9]{9})$/',Rule::unique('sellers')->ignore($this->id)],
            ...
            'company_registration_number'  =>  ['required_if:type,'.Seller::LEGAL_PERSON,'string','max:12'],
            'company_national_id'          =>  ['required_if:type,'.Seller::LEGAL_PERSON,'string','max:12'],
            'company_economic_code'        =>  ['required_if:type,'.Seller::LEGAL_PERSON,'string','max:12'],
